    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cuisine_types', models.CharField(choices=[('african', 'African'), ('american', 'American'), ('caribbean', 'Caribbean'), ('asian', 'Asian'), ('middle_eastern', 'Middle Eastern'), ('chinese', 'Chinese'), ('indian', 'Indian'), ('pakistani', 'Pakistani'), ('indonesian', 'Indonesian'), ('eastern_european', ' Eastern European'), ('irish', 'Irish'), ('english', 'English'), ('welsh', 'Welsh'), ('mexican', 'Mexican')], default='african', max_length=50)),
